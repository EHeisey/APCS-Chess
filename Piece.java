...
public abstract class Piece {
    ...
    /**
    * constructor Piece(Color c, String i) - creates a piece of that color and assigns its identifying string
    ...
    */
    ...
    /**
    method currentSquare() - returns the current square of the piece, or null if it does not exist
    @param none
    ...
    */
    ...
    @return true if p2 is a different color, false if p2 is same color as this piecee
    */
